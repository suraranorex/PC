...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ApplicationUnderTest.txt_CorreoPrincipal' at Center.", repo.ApplicationUnderTest.txt_CorreoPrincipalInfo, new RecordItemIndex(17));
            repo.ApplicationUnderTest.txt_CorreoPrincipal.Click();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$correoprincipal' with focus on 'ApplicationUnderTest.txt_CorreoPrincipal'.", repo.ApplicationUnderTest.txt_CorreoPrincipalInfo, new RecordItemIndex(18));
            repo.ApplicationUnderTest.txt_CorreoPrincipal.PressKeys(correoprincipal);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ApplicationUnderTest.lbl_Email' at Center.", repo.ApplicationUnderTest.lbl_EmailInfo, new RecordItemIndex(19));
            repo.ApplicationUnderTest.lbl_Email.Click();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Wait", "Waiting 30s to not exist. Associated repository item: 'ApplicationUnderTest.Copy_of_txt_CorreoPrincipal'", repo.ApplicationUnderTest.Copy_of_txt_CorreoPrincipalInfo, new ActionTimeout(30000), new RecordItemIndex(20));
